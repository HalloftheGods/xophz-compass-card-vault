...
define( 'XOPHZ_COMPASS_CARD_VAULT_VERSION', '26.9.17-1320' );
...
require_once XOPHZ_COMPASS_CARD_VAULT_PATH . 'includes/class-card-vault-price-history.php';
